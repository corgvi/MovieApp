...
import com.example.projectdemosmac.databinding.ItemMovieSearchBinding;
...
public class MovieSearchListAdapter extends RecyclerView.Adapter<MovieSearchListAdapter.MovieViewHolder>{
    ...
    public MovieSearchListAdapter(List<Result> listMovie, Context context) {
    ...
    class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieViewHolder(@NonNull ItemMovieSearchBinding binding) {
